...
let questions = [
   {
       ...
       answers: [
           ...
           {option: "Oject Based", answer: false},
       ]
   },
   {
   ...
   },
   {
       ...
       answers: [
           {option: "The contents are displayed by non-Js-based browers", answer: true},
           {option: "Clear all the cookies and cache", answer: false},
       ]
   }
]
